...
- [Scrcpy](https://github.com/Genymobile/scrcpy) Display and control your Android device {{< keyline >}} FOSS {{< /keyline >}}
...
### Android
- [Revanced](https://revanced.app/) - Open source patches for your favourite apps {{< keyline >}} FOSS {{< /keyline >}}
- [Seal](https://github.com/JunkFood02/Seal) - Video/Audio Downloader (yt-dlp) {{< keyline >}} FOSS {{< /keyline >}}
...
- Ventoy[https://www.ventoy.net/en/index.html] - Multi-ISO bootable USB (can use as normal usb too) {{< keyline >}} FOSS {{< /keyline >}} ⭐
- qdirstat - Cross platform disk analyzer
...
- [WizTree](https://diskanalyzer.com/) - Insanely Fast Disk Analyzer and Visualizer ⭐
- [Microsoft PowerToys](https://github.com/microsoft/PowerToys) - Collection of really useful utiliteies {{< keyline >}} FOSS {{< /keyline >}} ⭐ 
- [NanaZip](https://github.com/M2Team/NanaZip) - 7zip for Win11 (modernized) {{< keyline >}} FOSS {{< /keyline >}} ⭐
...
- [Home Assistant](https://www.home-assistant.io/) - Home automation / Smart home {{< keyline >}} TBD {{< /keyline >}}
- [Grafana](https://github.com/grafana/grafana) - Data Visualization platform {{< keyline >}} TBD {{< /keyline >}}
- [beszel](https://beszel.dev/) - Simple server monitoring {{< keyline >}} TBD {{< /keyline >}}
...
- [Revanced Pre-built](https://github.com/FiorenMas/Revanced-And-Revanced-Extended-Non-Root) - Pre-built revanced apk's ⭐
- [FreeDNS](https://freedns.afraid.org/) - Free subdomains
- [NextDNS](https://nextdns.io/) - DNS level Ad-blocking for all devices ⭐
